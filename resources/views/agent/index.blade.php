    ...
    <div class="col-sm-6 col-lg-3">
        <div class="card text-center">
            <div class="card-body">
                ...
                <h2 class="mt-3 mb-2"><b>{{format_price(Auth::user()->deposits->sum('amount'))}}</b>
                </h2>
            </div>
        </div>
    </div>
    ...
    <div class="col-sm-6 col-lg-3">
        <div class="card text-center">
            <div class="card-body p-t-10">
                ...
                <h2 class="mt-3 mb-2"><b>{{ format_price(Auth::user()->transactions->where('type','steama')->where('status','1')->sum('amount'))}}</b></h2>
            </div>
        </div>
    </div>
    <div class="col-sm-6 col-lg-3">
        <div class="card text-center">
            <div class="card-body p-t-10">
                ...
                <h2 class="mt-3 mb-2"><b>{{ format_price(Auth::user()->transactions->sum('amount'))}}</b></h2>
            </div>
        </div>
    </div>
</div>
