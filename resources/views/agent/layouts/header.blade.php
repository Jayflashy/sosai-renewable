    ...
    <div class="navbar-header">
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                <a href="{{route('agent.index')}}" class="logo logo-dark">
                    <span class="logo-sm">
                ...
                <a href="{{route('agent.index')}}" class="logo logo-light">
                    <span class="logo-sm">
                        <img src="{{my_asset(get_setting('favicon'))}}" alt="" height="26">
                    </span>
                    <span class="logo-lg">
        ...
        <div class="d-flex">
            <span class="my-auto fw-bold">
                Wallet: {{format_price(Auth::user()->balance)}}
            </span>
                ...
                <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end p-0"
                    ...
                    <div class="p-3">
                        <div class="row align-items-center">
                            ...
                            <div class="col-auto">
                                <a href="{{route('agent.transactions')}}" class="small"> View All</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="p-2 border-top">
                        <div class="d-grid">
                            <a class="btn btn-sm btn-link font-size-14 text-center" href="{{route('agent.transactions')}}">
            ...
            <div class="dropdown d-inline-block user-dropdown">
                <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                    ...
                    <img class="rounded-circle header-profile-user" src="{{(Auth::user()->image != null) ?my_asset(Auth::user()->image) : static_asset('img/profile.jpg')}}"
                        alt="">
